...
setCaptions = function() {
  var dot, hour, hourArc, minArc, minute, secArc, sec, msec,now, pos;
  now = new Date();
  ...
  $('.clockArc.minute').attr('d', describeArc(500, 240, 170, 0, minArc));
	$('.clockArc.second').attr('d', describeArc(500, 240, 190, 0, secArc));
  ...
  $('.clockDot.minute').attr('d', describeArc(500, 240, 170, minArc - 1, minArc));
	$('.clockDot.second').attr('d', describeArc(500, 240, 190, secArc - 1, secArc));
  ...
  dot.attr("cy", pos.y);
	dot = $(".clockDot.second");
	pos = polarToCartesian(500, 240, 190, secArc);
	dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
